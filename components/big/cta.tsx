...
export default function CTA() {
    return (
        <a href="/sign-up">
            <Button className="bg-white hover:bg-gray-100 text-black border border-brand-primary shadow shadow-brand-primary/30 rounded-full text-lg p-6 inline-flex items-center justify-center group/CTA gap-1">
                Start to
